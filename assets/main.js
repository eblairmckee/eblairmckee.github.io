$(document).ready(() => {
    $('#catWebDev').on('click', (e) => {
        $('.item').show();
        $('.item').not('.cat--webdev').fadeOut(500);
        e.preventDefault();
        return false;
    });
    $('#catWebDesign').on('click', (e) => {
        $('.item').show();
        $('.item').not('.cat--design').fadeOut(500);
        e.preventDefault();
        return false;
    });
    $('#catUX').on('click', (e) => {
        $('.item').show();
        $('.item').not('.cat--ux').fadeOut(500);
        e.preventDefault();
        return false;
    });
    $('#catWordPress').on('click', (e) => {
        $('.item').show();
        $('.item').not('.cat--wordpress').fadeOut(500);
        e.preventDefault();
        return false;
    });
    $('#catVideo').on('click', (e) => {
        $('.item').show();
        $('.item').not('.cat--video').fadeOut(500);
        e.preventDefault();
        return false;
    });
});
